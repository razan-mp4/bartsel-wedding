...
useEffect(() => {
  ...
  return (
    <section className="relative min-h-[100svh] overflow-hidden">
      ...
      <div
        className={`absolute inset-0 bg-black/28 transition-opacity duration-[1400ms] ease-out ${
          imageLoaded ? 'opacity-100' : 'opacity-0'
        }`}
      />
      <div
        className={`absolute inset-0 bg-gradient-to-b from-black/15 via-black/10 to-black/30 transition-opacity duration-[1400ms] ease-out ${
          imageLoaded ? 'opacity-100' : 'opacity-0'
        }`}
      />
      ...
      {/* OVERLAY */}
      <div
        className={`absolute inset-0 z-20 bg-[#f3efe8] transition-opacity duration-[1600ms] ease-out ${
